...
release = grooveshark.__version__
...
man_pages = [
    ('index', 'groovesharkpython', u'Grooveshark-Python Documentation',
     [u'Maximilian Köhl'], 1)
]
...
texinfo_documents = [
  ('index', 'Grooveshark-Python', u'Grooveshark-Python Documentation',
   u'Maximilian Köhl', 'Grooveshark-Python', 'One line description of project.',
   'Miscellaneous'),
]
